...
class Checkout5Widget extends StatefulWidget {
  const Checkout5Widget({super.key});

  static String routeName = 'Checkout5';
  static String routePath = 'checkout5';

  @override
  State<Checkout5Widget> createState() => _Checkout5WidgetState();
}
