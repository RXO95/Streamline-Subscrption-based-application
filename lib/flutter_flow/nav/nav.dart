      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: Checkout5Widget.routeName,
              path: Checkout5Widget.routePath,
              builder: (context, params) => Checkout5Widget(),
            ),
            FFRoute(
              name: ProductnetflixWidget.routeName,
              path: ProductnetflixWidget.routePath,
              builder: (context, params) => ProductnetflixWidget(),
            )
