...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0E1444);
  late Color secondary = const Color(0xFFE9FFB2);
  late Color tertiary = const Color(0xFFE7E5FD);
  late Color alternate = const Color(0xFFFAE2F1);
  late Color primaryText = const Color(0xFF0E1444);
  late Color secondaryText = const Color(0xFFF2F2F2);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF9F7F4);
...
class ThemeTypography extends Typography {
  ...
  TextStyle get displaySmall => GoogleFonts.titanOne(
        color: theme.primaryText,
  ...
  TextStyle get headlineMedium => GoogleFonts.titanOne(
